...
_[NEW] For the **BCMU 1.16/4.04** release please use **SW_Modbus-software** to initialize the default parameters: https://github.com/PSM-support/SW_Modbus-software_
